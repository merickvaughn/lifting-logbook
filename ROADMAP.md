...
| [Weekly Sets per Muscle Group and Movement Pattern](docs/proposals/2026-09-25-weekly-sets-per-muscle-group.md) | Built-in, per-user-overridable primary/secondary muscle groups for every catalog lift. Weekly working-set counts (primary 1, secondary ½) by muscle group or by movement pattern, with patterns classified relative to the torso. Shown on the program Browse/editor views, the Cycle Program page, and the dashboard's current week (planned, net of skips and swaps, vs. done) | [#1013](https://github.com/merickvaughn/lifting-logbook/issues/1013) | accepted |
